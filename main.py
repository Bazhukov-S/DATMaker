...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.message.reply_text("Вы хотите начать создание модели?")
...
def main() -> None:
    ...
    application = Application.builder().token("6593404619:AAEMwvBPipD9_w76tspKiLC1hDzoPZ0Pnbk").build()
